...
QT_MOC_LITERAL(3, 20, 12) // "clicked_fill"

    },
    "clicklabel\0clicked\0\0clicked_fill"
};
...
void clicklabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (clicklabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&clicklabel::clicked_fill)) {
                *result = 1;
                return;
            }
        }
